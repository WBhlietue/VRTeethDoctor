...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(112.000000,251.000000,139.000000,69.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(181.500000,0.014388,0.500000,300.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	FLWCScalar Local1 = LWCGetZ(DERIV_BASE_VALUE(Local0));
	FLWCScalar Local2 = LWCSubtract(DERIV_BASE_VALUE(Local1), LWCPromote(Material.PreshaderBuffer[2].x));
	FLWCScalar Local3 = LWCMultiply(DERIV_BASE_VALUE(Local2), LWCPromote(Material.PreshaderBuffer[2].y));
	FLWCScalar Local4 = LWCAbs(DERIV_BASE_VALUE(Local3));
	MaterialFloat Local5 = LWCSaturate(DERIV_BASE_VALUE(Local4));
	MaterialFloat Local6 = (1.00000000 - DERIV_BASE_VALUE(Local5));
	MaterialFloat Local7 = PositiveClampedPow(DERIV_BASE_VALUE(Local6),Material.PreshaderBuffer[2].z);
	MaterialFloat Local8 = (DERIV_BASE_VALUE(Local7) * Material.PreshaderBuffer[2].w);
	MaterialFloat3 Local9 = lerp(((MaterialFloat3)DERIV_BASE_VALUE(Local8)),Material.PreshaderBuffer[3].yzw,Material.PreshaderBuffer[3].x);
