...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.775000,0.677200,0.432600,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.775000,0.677200,0.432600,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.500000,0.008000,0.000000,0.000000);//(Unknown)
