...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.557292,0.557292,0.557292,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.557292,0.557292,0.557292,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.310574,0.310574,0.310574,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.000000,0.500000,0.230000,0.100000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local12 = lerp(Material.PreshaderBuffer[6].w,Material.PreshaderBuffer[6].z,0.50000000);
	MaterialFloat Local13 = saturate(Local12);
	MaterialFloat Local14 = (DERIV_BASE_VALUE(Local13) * Material.PreshaderBuffer[7].x);
	MaterialFloat Local15 = (1.00000000 - DERIV_BASE_VALUE(Local14));
	MaterialFloat Local16 = PositiveClampedPow(DERIV_BASE_VALUE(Local15),1.50000000);
