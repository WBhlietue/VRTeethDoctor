...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,1.000000,0.750000,0.750000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.750000,0.750000,1.000000,1.000000);//(Unknown)
