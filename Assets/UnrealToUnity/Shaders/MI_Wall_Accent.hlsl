...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(8.000000,1.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.340000,0.389583,0.425000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.340000,0.389583,0.425000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.115600,0.151775,0.180625,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.000000,0.500000,0.690000,0.100000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.489835,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local10 = lerp(Material.PreshaderBuffer[6].x,Material.PreshaderBuffer[5].w,Local8.r);
	MaterialFloat Local11 = saturate(Local10);
	MaterialFloat Local12 = lerp(Material.PreshaderBuffer[6].w,Material.PreshaderBuffer[6].z,Local8.r);
	MaterialFloat Local13 = saturate(Local12);
	MaterialFloat Local14 = (Local13 * Material.PreshaderBuffer[7].x);
	MaterialFloat Local15 = (1.00000000 - Local14);
	MaterialFloat Local16 = PositiveClampedPow(Local15,1.50000000);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Material.PreshaderBuffer[5].xyz;
	PixelMaterialInputs.Metallic = Local11;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[6].y;
	PixelMaterialInputs.Roughness = Local16;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = MaterialFloat3(Local5,Local3.b);
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Material.PreshaderBuffer[10].xyz;
