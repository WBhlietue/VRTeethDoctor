...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[7] = float4(0.542010,0.668403,0.524867,1.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.542010,0.668403,0.524867,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 3);
	MaterialFloat4 Local17 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[8].w;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[9].x;
	PixelMaterialInputs.Roughness = Local17.r;
