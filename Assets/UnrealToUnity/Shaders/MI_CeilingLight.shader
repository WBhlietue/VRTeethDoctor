Shader "Unreal/MI_CeilingLight"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_CeilingLinghtStool_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_CeilingLinghtStool_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_CeilingLinghtStool_ORM", 2D ) = "white" {}
