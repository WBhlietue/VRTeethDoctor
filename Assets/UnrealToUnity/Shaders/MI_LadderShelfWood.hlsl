...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[7] = float4(0.500000,0.500000,0.200000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 3);
	MaterialFloat4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 3);
	MaterialFloat Local18 = lerp(Material.PreshaderBuffer[7].z,Material.PreshaderBuffer[7].y,Local16.r);
	...
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[7].x;
