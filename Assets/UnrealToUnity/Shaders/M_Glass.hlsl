...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.350000,10.000000,1.400000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local7 = (Local6 + 0.00000000);
	MaterialFloat Local8 = lerp(1.00000000,Material.PreshaderBuffer[4].w,Local7);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local8,0.0f),Material.PreshaderBuffer[5].x);
