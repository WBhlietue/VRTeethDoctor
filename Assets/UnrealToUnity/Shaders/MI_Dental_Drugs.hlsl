...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local5 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	MaterialFloat Local11 = dot(Local9.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local12 = lerp(Local9.rgb,((MaterialFloat3)Local11),Material.PreshaderBuffer[2].x);
	MaterialFloat3 Local13 = (Local12 * Material.PreshaderBuffer[4].xyz);
	MaterialFloat3 Local14 = (Local13 * ((MaterialFloat3)Material.PreshaderBuffer[4].w));
	MaterialFloat4 Local15 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 2);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local9.a;
