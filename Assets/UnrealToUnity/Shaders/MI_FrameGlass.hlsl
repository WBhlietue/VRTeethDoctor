...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.072500,0.072500,0.072500,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.072500,0.072500,0.072500,0.329800);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.509000,1.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local9 = lerp(1.00000000,Material.PreshaderBuffer[4].z,Local8);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local9,0.0f),Material.PreshaderBuffer[4].w);
