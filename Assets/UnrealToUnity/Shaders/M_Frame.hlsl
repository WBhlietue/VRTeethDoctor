...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.487765,0.447871,0.383775,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.487765,0.447871,0.383775,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.500000,1.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = (Material.PreshaderBuffer[3].xyz * ((MaterialFloat3)Local6.r));
	MaterialFloat Local9 = lerp(Material.PreshaderBuffer[4].y,Material.PreshaderBuffer[4].x,Local6.r);
	...
	PixelMaterialInputs.Roughness = Local9;
