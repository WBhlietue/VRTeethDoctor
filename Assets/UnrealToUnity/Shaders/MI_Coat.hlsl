...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,1.000000,8.000000,8.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(8.000000,8.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local7), 2);
	MaterialFloat4 Local16 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local7),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Roughness = Local16.g;
