...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(4.000000,0.250000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.774305,0.609483,0.414039,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.774305,0.609483,0.414039,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.500000,0.000000,0.500000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local5 = (((MaterialFloat2)Material.PreshaderBuffer[1].y) * Local3.rgb.rg);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = MaterialFloat3(Local5,Local3.b);
	...
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 2);
	...
	MaterialFloat Local14 = lerp(Material.PreshaderBuffer[5].x,Material.PreshaderBuffer[4].w,Local12.r);
	MaterialFloat Local15 = saturate(Local14);
	MaterialFloat Local16 = lerp(Material.PreshaderBuffer[5].w,Material.PreshaderBuffer[5].z,Local12.r);
	MaterialFloat Local17 = saturate(Local16);
	MaterialFloat Local18 = (Local17 * Material.PreshaderBuffer[6].x);
	MaterialFloat Local19 = (1.00000000 - Local18);
	MaterialFloat Local20 = PositiveClampedPow(Local19,1.50000000);
	MaterialFloat4 Local21 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 1);
	MaterialFloat3 Local23 = (Local21.rgb * Material.PreshaderBuffer[8].xyz);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local10;
	PixelMaterialInputs.Metallic = Local15;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[5].y;
	PixelMaterialInputs.Roughness = Local20;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = MaterialFloat3(Local5,Local3.b);
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local23;
